<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <form action="{{ route('invoices.destroy',$item->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro que deseas ocultar a esta factura?');">
          @method('DELETE')
          @csrf
          ...
          <button type="submit" class="btn btn-danger btn-sm" title="Ocultar factura"><i class="fa fa-minus-circle"></i></button>
        </form>
      </td>
    </tr>
    @endif
