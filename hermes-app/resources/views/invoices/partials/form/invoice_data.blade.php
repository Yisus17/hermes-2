<div id="invoice-data" class="row mb-2">
  ...
  <div class="form-group col-6">
    ...
    <select name="validity" class="form-control">
      ...
      <option value="{{$key}}" {{(isset($invoice) && $key == $invoice->validity) || old('validity') == $key ? 'selected' : '' }}>
        {{$value}}
      </option>
      @endforeach
    </select>
...
<!-- 
  ...
  <div class="form-group col-12 col-sm-4">
    <label for="payment_conditions">Condiciones de pago</label>
    <div class="input-group">
      <input type="text" name="payment_conditions" class="form-control" value="{{isset($invoice) ? $invoice->payment_conditions :old('payment_conditions')}}" />
    </div>
  </div>
  ...
  <div class="form-group col-4">
    ...
    <select name="payment_method" class="form-control">
      ...
      <option value="{{$key}}" {{(isset($invoice) && $key == $invoice->payment_method) || old('payment_method') == $key ? 'selected' : '' }}>
        {{$value}}
      </option>
      @endforeach
    </select>
  ...
  <div class="form-group col-4">
    ...
    <div class="input-group">
      <input type="number" name="tax_percentage" class="form-control" min="0" max="100" step="1" value="{{isset($invoice) ? $invoice->tax_percentage : 21}}" />
      <div class="input-group-append">
